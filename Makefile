...
build/Coin.o : $(SOURCE)/Coin.h $(SOURCE)/Coin.cc
	$(CCC) $(CCFLAGS) -c $(SOURCE)/Coin.cc -o build/Coin.o
...
build/Health_Orb.o : $(SOURCE)/Health_Orb.h $(SOURCE)/Health_Orb.cc
	$(CCC) $(CCFLAGS) -c $(SOURCE)/Health_Orb.cc -o build/Health_Orb.o
